...
export interface paths {
    ...
    "/api/v1/cobranza/saldos-por-proyecto": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Saldos Por Proyecto
         * @description Una fila por proyecto: saldo, vencido y cuántas facturas, más el total.
         *
         ...
         */
        get: operations["saldos_por_proyecto_api_v1_cobranza_saldos_por_proyecto_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/correo": {
        ...
        /**
         * Quitar Correo
         * @description Borra la configuración de correo del tenant y regresa la pantalla al
         ...
         */
        delete: operations["quitar_correo_api_v1_correo_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/v1/productos/alias/{alias_id}": {
        ...
        /**
         * Reapuntar Alias
         * @description Corrige el renglón: el texto, el producto y/o la sucursal del cliente.
         */
...
export interface operations {
    ...
    saldos_por_proyecto_api_v1_cobranza_saldos_por_proyecto_get: {
        parameters: {
            query?: {
                /** @description Incluir las facturas cuya cancelación ya se pidió al SAT (por omisión se excluyen) */
                incluir_en_cancelacion?: boolean;
    ...
    quitar_correo_api_v1_correo_delete: {
        parameters: {
            query?: never;
            header?: {
                "X-Tenant-Id"?: string | null;
