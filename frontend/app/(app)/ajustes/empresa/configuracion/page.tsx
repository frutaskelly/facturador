...
import { ArrowLeft, Building2, CheckCircle2, Pencil, ShieldCheck, Upload, Check, X } from "lucide-react";
...
export default function EmpresaConfiguracionPage() {
  ...
  // Nombre de la empresa de ESTA pestaña: con dos empresas abiertas a la vez,
  // el encabezado tiene que decir sobre cuál se está trabajando.
  const empresaActiva = me?.tenants.find((t) => t.tenant_id === me.active_tenant.tenant_id);
  ...
  return (
    <div className="space-y-4">
      ...
      <PageHeader
        title={empresaActiva?.name ?? "Empresa"}
        subtitle="Datos fiscales del emisor, sello digital (CSD) y logo"
      />
